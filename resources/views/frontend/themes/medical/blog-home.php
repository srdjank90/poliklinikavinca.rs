                  ...
                  <div class="col-lg-12">
                     <div class="text-center">
                        <div class="text-center">
                           ...
                           <p class="fw-normal text-white-50 mb-0"><a class="text-white" href="index.php">Početna</a> <i class="bi-arrow-right"></i> Saveti stručnjaka</p>
                        </div>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="card-body p-0">
                        <div class="row gx-0">
                           <div class="col-lg-6 col-xl-7">
                              <div class="bg-featured-blog" style="background-image: url('img/big-blog.png')"></div>
                           </div>
                           <div class="col-lg-6 col-xl-5 py-lg-5">
                              <div class="p-4 p-md-5">
                                 <div class="badge bg-primary bg-gradient rounded-pill mb-2">News</div>
                                 <div class="h2 fw-bolder">The Most Hilarious Complaints We've Heard About Health</div>
               ...
               <div class="col-lg-4 mb-5">
                  <div class="card h-100 shadow-sm rounded-3 border-0">
                     ...
                     <div class="card-body p-4">
                        <div class="badge bg-primary bg-gradient rounded-pill mb-2">News</div>
                        <a class="text-decoration-none link-dark stretched-link" href="blog-post.php">
                           <h5 class="card-title mb-3 lh-base">Most People Don't Know About Medical Clinic</h5>
                        </a>
                        <p class="card-text mb-0">Adaptive height of each card this text is a bit longer to illustrate the. Some quick example text to build on the card title bulk of the card's content and make up the.</p>
                     </div>
                     <div class="card-footer p-4 pt-0 bg-transparent border-top-0">
                        <div class="d-flex align-items-end justify-content-between">
                           <div class="d-flex align-items-center">
                              <img class="rounded-circle me-3" src="img/u4.png" alt="...">
                              <div class="small">
                                 <div class="fw-bold">Kelly Rowan</div>
                                 <div class="text-muted">March 12, 2021 · 6 min read</div>
                              </div>
               ...
               <div class="col-lg-4 mb-5">
                  <div class="card h-100 shadow-sm rounded-3 border-0">
                     ...
                     <div class="card-footer p-4 pt-0 bg-transparent border-top-0">
                        <div class="d-flex align-items-end justify-content-between">
                           <div class="d-flex align-items-center">
                              <img class="rounded-circle me-3" src="img/u5.png" alt="...">
                              <div class="small">
                                 <div class="fw-bold">Evelyn Martinez</div>
                                 <div class="text-muted">April 2, 2021 · 10 min read</div>
                              </div>
               ...
               <div class="col-lg-4 mb-5">
                  <div class="card h-100 shadow-sm rounded-3 border-0">
                     ...
                     <div class="card-footer p-4 pt-0 bg-transparent border-top-0">
                        <div class="d-flex align-items-end justify-content-between">
                           <div class="d-flex align-items-center">
                              <img class="rounded-circle me-3" src="img/u6.png" alt="...">
                              <div class="small">
                                 <div class="fw-bold">Josiah Barclay</div>
                                 <div class="text-muted">March 23, 2021 · 4 min read</div>
                              </div>

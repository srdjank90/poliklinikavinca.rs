...
@section('content')
    ...
    <section class="py-5 bg-warning">
        <div class="container px-5 my-5 text-center">
            ...
            <a class="btn btn-outline-dark fw-bold fs-7 rounded-3 px-4 py-3 text-uppercase" href="appointment.php">Zakažite
                pregled</a>
        </div>
    </section>
    <!-- Testimonial section-->
                ...
                <div class="col-lg-4 mb-5">
                    <div class="card h-100 shadow-sm rounded-3 border-0">
                        ...
                        <div class="card-body p-4">
                            ...
                            <p class="card-text mb-0">Adaptive height of each card this text is a bit longer to illustrate
                                the. Some quick example text to build on the card title bulk of the card's content and make
                                up the.</p>
                        </div>
                    ...
                    <div class="card h-100 shadow-sm rounded-3 border-0">
                        ...
                        <div class="card-body p-4">
                            ...
                            <p class="card-text mb-0">Some quick example text to build on the card title and make up the
                                bulk of the card's content This text is a bit longer to illustrate the adaptive height of
                                each card.</p>
                        </div>
                        <div class="card-footer p-4 pt-0 bg-transparent border-top-0">
                            <div class="d-flex align-items-end justify-content-between">

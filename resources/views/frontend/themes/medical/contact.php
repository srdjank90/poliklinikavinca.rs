            ...
            <div class="row align-items-center gx-5">
               <div class="col-lg-6">
                  ...
                  <div class="row gx-5 row-cols-2 row-cols-lg-2 pt-5">
                     <div class="col my-3">
                        ...
                        <div class="h5 mb-2"><a href="appointment.php">Zakažite Vaš pregled</a></div>
                     ...
                     <div class="col my-3">
                        ...
                        <p class="text-muted mb-0">Pozovite našu laboratoriju tokom radnog vremena na (060) 78 08 788.</p>
                     </div>
                     <div class="col my-3">
                        <div class="feature bg-primary bg-gradient text-white rounded-3 mb-3"><i class="bi bi-geo-alt"></i></div>
                        <div class="h5"><a href="https://www.google.com/maps/dir//%D0%9F%D1%80%D0%BE%D1%84%D0%B5%D1%81%D0%BE%D1%80%D0%B0+%D0%92%D0%B0%D1%81%D0%B8%D1%9B%D0%B0+24,+%D0%92%D0%B8%D0%BD%D1%87%D0%B0+11351/@44.7465637,20.5187105,12z/data=!4m8!4m7!1m0!1m5!1m1!1s0x475a775655265b17:0xd4c5b3b13f6cebe3!2m2!1d20.6011111!2d44.7465933?entry=ttu&g_ep=EgoyMDI0MDkxMS4wIKXMDSoASAFQAw%3D%3D" target="_blank">Naša lokacija</a></div>
               ...
               <div class="col-lg-6">
                  <div class="bg-white shadow-sm p-5 rounded-3">
                     ...
                     <p class="text-muted fw-light">Imate sugestiju, pitanje, pohvalu ili jednostavno želite da zakažete pregled.</p>
                     <form action="https://webartinfo.com/themeforest/medicil/index.php" class="text-start pt-3">
                        ...
                        <div class="row">
                           <div class="mb-3 col-6 pe-2">
                              ...
                              <input type="number" class="form-control" placeholder="Upišite broj telefona">
                           </div>
                           <div class="mb-3 col-6 ps-2">
                              <label class="form-label small text-muted">E-mail adresa <small class="text-danger">*</small></label>
                              <input type="email" class="form-control" placeholder="Upišite E-mail">
                           </div>
                        </div>
                        <div class="mb-3">
                           <label class="form-label small text-muted">Poruka <small class="text-danger">*</small></label>
                           <textarea class="form-control hight-auto" placeholder="Ovde upišite vašu poruku..." rows="4" data-sb-validations="required"></textarea>
                        </div>
                        <button type="button" class="btn btn-warning fw-bold fs-7 rounded-3 w-100 border-0 px-4 py-3 text-uppercase">Pošaljite</button>
                     </form>
                  </div>
               </div>
            </div>

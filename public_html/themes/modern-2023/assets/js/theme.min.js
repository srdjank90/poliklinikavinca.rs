...
(function (e) {
        ...
        (APP.animation = {
            ...
            init: function () {
                ...
                (t.$wrapper = e("body")),
                    (t.itemQueue = []),
                    (t.queueTimer = null),
                    typeof delay != "undefined" && (t.delay = delay),
                    (t.itemQueue.animated_0 = []),
                    e("body")
                        .find("#content")
                        .find(">div,>section")
                        .each(function (n) {
                            e(this).attr("data-animated-id", n + 1),
                                (t.itemQueue["animated_" + (n + 1)] = []);
                        }),
                    setTimeout(function () {
                        t.registerAnimation();
                    }, 200);
                ...
                e(
                    ...
                    function () {
                        var s,
                            ...
                            n = e(i);
                        n.is(":visible")
                            ? ((s = n.closest("[data-animated-id]")),
                              (o = "0"),
                              s.length && (o = s.data("animated-id")),
                              t.itemQueue["animated_" + o].push(i),
                              t.processItemQueue())
                            : n
                                  .addClass("animate__" + n.data("animate"))
            ...
            processItemQueue: function () {
                ...
                t.queueTimer = window.setInterval(function () {
                    ...
                    for (let e in t.itemQueue)
                        if (t.itemQueue[e].length) {
                            s = !0;
                            break;
                        }

                    if (s) {
                        for (let s in t.itemQueue)
                            (n = e(t.itemQueue[s].shift())),
                                n
                                    .addClass("animate__" + n.data("animate"))
                                    .addClass("animate__animated");
    ...
    (() => {
        ...
        const t = new ClipboardJS(".btn-clipboard", {
            target: (e) =>
                e
                    .closest(".doc-code-snippet")
                    .querySelector(".doc-example-markup"),
        });
        t.on("success", (t) => {
                ...
                c.attr("data-bs-toggle", !1),
                    a.on("show.bs.tab", function () {
                        var i = e(this).attr("data-bs-target"),
                            ...
                            c = s.find(".collapse");
                        t.switchDataToggle(a, r),
                            t.switchStatusActive(o, c, "show");
                    }),
                    o.on("show.bs.collapse", function () {
                        ...
                        o.removeClass("show"),
                            t.switchDataToggle(d, u),
                            t.switchStatusActive(a, h, "active"),
                            t.switchStatusActive(i, s, "active"),
                            t.switchStatusActive(i, s, "show");
                    });
            },
            switchDataToggle: function (e, t) {
                e.attr("data-bs-toggle", "collapse"),
                    t.attr("data-bs-toggle", !1);
            },
        ...
        APP.core = {
            ...
            isDeviceUp: function (e) {
                return window.matchMedia(
                    "(min-width: " + APP.core._devices[e] + "px)"
                ).matches;
            },
            isDeviceDown: function (e) {
                return window.matchMedia(
                    "(max-width: " + (APP.core._devices[e] - 1) + "px)"
                ).matches;
            },
        };
    })(jQuery),
            ...
            init: function () {
                ...
                (n = t.data("countdown-end")),
                    ...
                    (o = setInterval(function () {
                        ...
                        e(".day").html(i),
                            e(".hour").html(("0" + a).slice(-2)),
                            e(".minute").html(("0" + r).slice(-2)),
                            e(".second").html(("0" + c).slice(-2)),
                            t < 0 && clearInterval(o);
                    }, 1e3));
            },
        }),
    ...
    (function (e) {
        ...
        e(document).on("show.bs.dropdown", function (n) {
            ...
            e(document).on("hide.bs.dropdown", function (n) {
                if (e(n.target).closest("#offCanvasNavBar").length === 0)
                    return;
                e(n.target)
                    .parent()
                    .find("." + t).length && n.preventDefault(),
                    e("#offCanvasNavBar")
                        .find("." + t)
                        .removeClass(t),
                    e(n.target).closest(".nav-item") &&
                        !e(n.target).parent().hasClass("nav-item") &&
                        (n.clickEvent === void 0 ||
                            (n.clickEvent &&
                                n.clickEvent.target === n.target)) &&
                        e(n.target).addClass(t);
            });
    })(jQuery),
    (APP = APP || {}),
    (function (e) {
        ...
        (APP.fullPageScroll = {
            ...
            init: function () {
                ...
                if (
                    ((this._slides =
                        document.querySelectorAll("[data-full-page]")),
                    (this.$_dots = e(".full-page-dots")),
                    this.$_dots.length === 0 &&
                        ((this.$_dots = e(
                            '<div class="full-page-dots"></div>'
                        )),
                        e("body").append(this.$_dots)),
                    this.$_dots.length)
                ) {
                    for (let t = 0; t < this._slides.length; t++) {
                        let n = e('<div class="full-page-dots-nav"></div>');
                        n.attr("title", e(this._slides[t]).data("full-page")),
                            n.attr("data-index", t),
                            this.$_dots.append(n);
                    }
                    ...
                    this.$_dots.find(".full-page-dots-nav").each(function () {
                        ...
                        this.$_dots
                            .find(".full-page-dots-nav")
                            .on("click", function () {
                                let t = e(this).attr("data-index");
                                (APP.fullPageScroll._isEnabled = !1),
                                    APP.fullPageScroll.gotoSlide(t);
                            });
                }

                document.addEventListener("mousedown", function (e) {
                    e.target === document.querySelector("html") &&
                        APP.fullPageScroll._tween &&
                    ...
                    window.addEventListener("wheel", function (e) {
                        if (
                            ((APP.fullPageScroll._oldSlide =
                                APP.fullPageScroll._activeSlide),
                            (APP.fullPageScroll._activeSlide +=
                                e.deltaY > 0 ? 1 : -1),
                            APP.fullPageScroll._activeSlide < 0 &&
                                (APP.fullPageScroll._activeSlide = 0),
                            APP.fullPageScroll._activeSlide >
                                APP.fullPageScroll._slides.length &&
                                (APP.fullPageScroll._activeSlide =
                                    APP.fullPageScroll._slides.length),
                            APP.fullPageScroll._activeSlide ===
                                APP.fullPageScroll._oldSlide)
            ...
            activeDot: function (t) {
                ...
                if (APP.fullPageScroll.$_dots.length) {
                    ...
                    APP.fullPageScroll.$_dots.removeClass("dark light"),
                        s !== void 0 && APP.fullPageScroll.$_dots.addClass(s),
                        APP.fullPageScroll.$_dots
                            .find(".full-page-dots-nav")
                            .removeClass("active");
                    let o = APP.fullPageScroll.$_dots.find(
                        '.full-page-dots-nav[data-index="' + t + '"]'
                    );
                    o.addClass("active");
                }
            },
        ...
        (APP.headerSticky = {
            ...
            sticky: function () {
                e(".header-sticky .sticky-area").each(function () {
                    ...
                    t.parent().hasClass("sticky-area-wrap") ||
                        t.wrap('<div class="sticky-area-wrap"></div>'),
                        (n = t.parent()),
            ...
            processSticky: function () {
                ...
                t.hasClass("navbar-dark") && (s = !0),
                    e(".header-sticky .sticky-area").each(function () {
                        ...
                        r !== "" && (a += parseInt(r)),
                            o.hasClass("unset-mode-when-sticky") &&
                                o.attr("data-bs-theme") !== void 0 &&
                                document.documentElement.hasAttribute(
                                    "data-bs-theme"
                                ) &&
                                (this.bs_theme = o.attr("data-bs-theme")),
                            c - a < n
                                ? (o.css("position", "fixed"),
                                  ...
                                  o.hasClass("unset-mode-when-sticky") &&
                                      ...
                                      (o.removeAttr("data-bs-theme"),
                                      this.bs_theme !== void 0 &&
                                          o.removeAttr("data-bs-theme")),
                                  s &&
                                      (t.removeClass("navbar-dark"),
                                      t.addClass("navbar-light"),
                                      t.addClass("navbar-light-sticky")))
                                : (t.hasClass("navbar-light-sticky") &&
                                      (t.addClass("navbar-dark"),
                                      t.removeClass("navbar-light"),
                                      t.removeClass("navbar-light-sticky")),
                                  i.hasClass("sticky") &&
                                      (o.css("position", "").css("top", ""),
                                      i.removeClass("sticky")),
                                  o.hasClass("unset-mode-when-sticky") &&
                                      document.documentElement.hasAttribute(
                                          "data-bs-theme"
                                      ) &&
                                      o.attr("data-bs-theme", this.bs_theme));
                    }),
                    APP.headerSticky.scroll_offset_before > n
                        ? e(".header-sticky-smart .sticky-area").each(
                              function () {
                                  e(this).hasClass("header-hidden") &&
                                      e(this).removeClass("header-hidden");
                              }
                          )
                        : e(".header-sticky-smart .sticky-area").each(
                              function () {
            ...
            (APP.header = {
                init: function () {
                    e(".header.disable-transition-all").removeClass(
                        "disable-transition-all"
                    );
                },
            }),
            e(document).ready(function () {
            ...
            setupIsotopeFilter: function () {
                e("[data-isotope-filter]").on("click", function () {
                    ...
                    n.isotope({
                        ...
                        s.find("[data-isotope-filter]").removeClass("active"),
                        t.addClass("active");
                });
            },
        }),
        ...
        (APP.lazyLoad = {
            ...
            handleLazyBackgrounds: function () {
                this.instanceBackground = new LazyLoad({
                    ...
                    data_bg: "bg-src",
                    callback_loaded: function (t) {
                        e(t).removeClass("lazy-bg"),
                            e(t).find(".placeholder").remove();
                    },
                });
            },
            update: function () {
                e(".lazy-image").each(function () {
                    ...
                    this.instanceImage !== null && this.instanceImage.update(),
            ...
            init: function () {
                ...
                (n = {
                    ...
                    t.each(function () {
                        ...
                        (o.container = a),
                            (mapboxgl.accessToken = s.data(
                                "mapbox-access-token"
                            )),
                            (t = new mapboxgl.Map(o)),
                            (r = e(s.data("marker-target"))),
                            (i = r.find(".marker-item")),
                            i.length > 0
                                ? e.each(i, function () {
                                      ...
                                      (s.className = n.className),
                                          (s.style.backgroundImage =
                                              "url(" +
                                              e(this).data("icon-marker") +
                                              ")"),
                                          (s.style.width = n.style.width),
                                          (s.style.height = n.style.height),
                                          new mapboxgl.Marker(s)
                                              .setLngLat(
                                ...
                                : e.each(c, function () {
                                      ...
                                      (e.className = this.className),
                                          ...
                                          (n = new mapboxgl.Marker(e)
                                              .setLngLat(this.position)
                                              .addTo(t));
                                  }),
                            t.scrollZoom.disable(),
        ...
        (APP.preventTransitionResize = {
            ...
            resize: function () {
                e(window).resize(function () {
                    ...
                    if (t === APP.preventTransitionResize.beforeWindowWidth)
                        return;
                    (APP.preventTransitionResize.beforeWindowWidth = t),
                        clearTimeout(APP.preventTransitionResize.resizeTimer),
                        e("body").addClass("disable-transition-all"),
                        e(document).trigger("after_prevent_transition_resize"),
                        (APP.preventTransitionResize.resizeTimer = setTimeout(
                            function () {
        ...
        (APP.singleShop = {
            ...
            shopFBT: function () {
                ...
                t.unbind("click").on("click", function (s) {
                    ...
                    t.hasClass("checked")
                        ? (t.removeClass("checked"),
                          t.siblings(".form-check-input").prop("checked", !1),
                          t.html(
                              '<svg class="icon icon-plus"><use xlink:href="#icon-plus"></use></svg>'
                          ),
                          o(t, n, i))
                        : (t.addClass("checked"),
                          t.siblings(".form-check-input").prop("checked", !0),
                          t.html(
                ...
                function o(o, t, n) {
                    ...
                    o.attr("data-bs-title", n),
                        s.find(".tooltip-inner").html(n);
                }
            },
        }),
            e(document).ready(function () {
        ...
        (APP.slickSlider = {
            ...
            slickSetup: function (n) {
                ...
                var t,
                    s = {
                        ...
                        vertical: !1,
                        prevArrow:
                            '<div class="slick-prev" aria-label="Prev"><svg class="icon"><use xlink:href="#icon-chevron-left"></use></svg></div>',
                        nextArrow:
                            '<div class="slick-next" aria-label="Next"><svg class="icon"><use xlink:href="#icon-chevron-right"></use></svg></div>',
                ...
                t.each(function () {
                    ...
                    n.hasClass("slick-initialized") ||
                        ((t = n.data("slick-options")),
                        typeof t.appendArrow != "undefined" &&
                            (t.appendArrows = e(t.appendArrow)),
                        n.hasClass("custom-arrows-02") &&
                            ((t.prevArrow = e(".custom-arrows-02-prev")),
                            (t.nextArrow = e(".custom-arrows-02-next"))),
                        n.hasClass("our-best-seller-4") &&
                            (t.customPaging = function (t, n) {
                                var e,
                                    s = "";
                                return (
                                    n < 9 ? (s = n + 1) : (s = n + 1),
                        ...
                        (t = e.extend({}, s, t)),
                        n.slick(t),
                        n.on("setPosition", function (o, t) {
                            var s = 0;
                            t.$slides.each(function () {
                                var n = e(this);
                                n.hasClass("slick-active") &&
                                    t.options.adaptiveHeight &&
            ...
            animateSlider: function () {
                ...
                t.on("beforeChange", function () {
                    ...
                    n.each(function () {
                        (t = e(this).attr("data-animate")),
                            t.length &&
                                e(this)
                                    .removeClass("animate__animated")
                                    .removeClass("animate__" + t);
                    });
                }),
                    t.on("afterChange", function () {
                        var s = e(this).find(".slick-active"),
                            ...
                            t = "";
                        if (
                            (APP.lazyLoad && APP.lazyLoad.update(),
                            n.length <= 0)
                        )
                            return;
                        n.each(function () {
    ...
    (function (e) {
        ...
        (APP.tabs = {
            ...
            tab_accordion: function () {
                e('[data-bs-toggle="tab-accordion"] [data-bs-toggle="tab"]').on(
                    "shown.bs.tab",
                    function (t) {
                        var i = e(t.target),
                            a = e(t.relatedTarget),
                            n = e(this).closest(
                                '[data-bs-toggle="tab-accordion"]'
                            ),
                            s = n.find(i.data("bs-target")),
                            o = n.find(a.data("bs-target"));
                        s.find(".collapse").addClass("show"),
                            o.find(".collapse").removeClass("show"),
                            s
                    ...
                    e('[data-bs-toggle="tab-accordion"] .collapse').on(
                        "shown.bs.collapse",
                        function (i) {
                            var t,
                                n,
            ...
            tab_dropdown: function () {
                e('[data-bs-toggle="tab-dropdown"] [data-bs-toggle="tab"]').on(
                    "shown.bs.tab",
                    function (n) {
                        var s = e(n.target),
                            i = e(n.relatedTarget),
                            t = e(this).closest(
                                '[data-bs-toggle="tab-dropdown"]'
                            ),
                            o = s.data("bs-target");
                        t.find('[data-bs-toggle="tab"]').removeClass("active"),
                            t
                                .find('[data-bs-target="' + o + '"]')
                                .addClass("active"),
                            t
